...
QT_MOC_LITERAL(1, 13, 8), // "soc_conn"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 10), // "soc_discon"
QT_MOC_LITERAL(4, 34, 11), // "soc_sendMsg"
QT_MOC_LITERAL(5, 46, 9), // "connected"
QT_MOC_LITERAL(6, 56, 12), // "disconnected"
QT_MOC_LITERAL(7, 69, 7) // "on_recv"

    },
    "SocketThread\0soc_conn\0\0soc_discon\0"
    "soc_sendMsg\0connected\0disconnected\0"
    "on_recv"
};
...
void SocketThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->soc_conn(); break;
        case 1: _t->soc_discon(); break;
        case 2: _t->soc_sendMsg((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: _t->connected(); break;
        case 4: _t->disconnected(); break;
        case 5: _t->on_recv((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SocketThread::soc_conn)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SocketThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SocketThread::soc_discon)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SocketThread::soc_sendMsg)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void SocketThread::soc_conn()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SocketThread::soc_discon()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void SocketThread::soc_sendMsg(QString _t1)
{
